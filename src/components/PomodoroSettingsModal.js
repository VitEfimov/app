...
const predefinedSounds = [
  ...
  { label: 'Zen', value: 'koto_notification.mp3' },
  ...
  { label: 'Oak', value: 'cellos_pizz.mp3' },
  { label: 'Suspense', value: 'cellos_tremolo.mp3' },
  { label: 'Breeze', value: 'flute_test.mp3' },
  { label: 'Glow', value: 'glower.mp3' },
  { label: 'Keystone', value: 'keys.mp3' },
  { label: 'Keystone Soft', value: 'keys2.mp3' },
  { label: 'Amber', value: 'marinba.mp3' },
  { label: 'Pulse Bell', value: 'phonk_bell.mp3' },
  { label: 'Pluck', value: 'vpizzicato.mp3' },
  { label: 'Crystal', value: 'xylo.mp3' },
  { label: 'Pebble', value: 'xeloD.mp3' },
  { label: 'Cascade', value: 'xeloDFS.mp3' },
  { label: 'Echo', value: 'xelof.mp3' },
  { label: 'Aurora', value: 'marinbaEEFGE.mp3' },
  { label: 'Spark', value: 'violin_pizzicatoBEFE.mp3' },
  { label: 'Velvet', value: 'viola_solo_pizzicatoEGAG.mp3' },
  { label: 'Harmony', value: 'viola_solo_pizzicatoEGABEb.mp3' },
  { label: 'Whisper', value: 'violla_pizzicatoEGF.mp3' },
  { label: 'Timber', value: 'cellos_pizzEDF.mp3' },
  { label: 'Summit', value: 'cellos_pizzDGG.mp3' },
];
