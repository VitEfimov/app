...
export default function SettingsScreen({ navigation }) {
  ...
  const soundOptions = [
    ...
    { label: t('Zen'), value: 'koto_notification.mp3' },
    ...
    { label: t('Oak'), value: 'cellos_pizz.mp3' },
    { label: t('Suspense'), value: 'cellos_tremolo.mp3' },
    { label: t('Breeze'), value: 'flute_test.mp3' },
    { label: t('Glow'), value: 'glower.mp3' },
    { label: t('Keystone'), value: 'keys.mp3' },
    { label: t('Keystone Soft'), value: 'keys2.mp3' },
    { label: t('Amber'), value: 'marinba.mp3' },
    { label: t('Pulse Bell'), value: 'phonk_bell.mp3' },
    { label: t('Pluck'), value: 'vpizzicato.mp3' },
    { label: t('Crystal'), value: 'xylo.mp3' },
    { label: t('Pebble'), value: 'xeloD.mp3' },
    { label: t('Cascade'), value: 'xeloDFS.mp3' },
    { label: t('Echo'), value: 'xelof.mp3' },
    { label: t('Aurora'), value: 'marinbaEEFGE.mp3' },
    { label: t('Spark'), value: 'violin_pizzicatoBEFE.mp3' },
    { label: t('Velvet'), value: 'viola_solo_pizzicatoEGAG.mp3' },
    { label: t('Harmony'), value: 'viola_solo_pizzicatoEGABEb.mp3' },
    { label: t('Whisper'), value: 'violla_pizzicatoEGF.mp3' },
    { label: t('Timber'), value: 'cellos_pizzEDF.mp3' },
    { label: t('Summit'), value: 'cellos_pizzDGG.mp3' },
  ];
